...
const ClientDashboard = () => {
  ...
  const loadData = async () => {
    try {
      const [salonData, bookingsData, servicesData, slotsData] = await Promise.all([
        getSalon(SALON_ID),
    ...
    <div style={{ minHeight: '100vh', background: '#F5F0EA' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '50%',
              background: 'rgba(106,93,82,0.15)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: '13px', fontWeight: 600, color: '#6A5D52',
              cursor: 'pointer',
            }}
          >
            {initials}
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '32px 20px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: '#979086', fontSize: '14px' }}>
            Tvoj osobný beauty priestor
          </p>
        </div>
        ...
        {salon && (
          <div style={{
            background: 'linear-gradient(135deg, #D4C5B0 0%, #B7AC9B 60%, #A89070 100%)',
            borderRadius: '24px',
            padding: '28px',
            marginBottom: '28px',
            position: 'relative',
            ...
            <p style={{
              fontSize: '10px', color: 'rgba(245,240,234,0.7)',
            ...
            <h3 style={{
              fontFamily: 'Cormorant Garamond, serif',
              fontSize: '1.5rem', color: '#F5F0EA',
              marginBottom: '4px', fontWeight: 400,
            }}>
              {salon.name}
            </h3>
            <p style={{ fontSize: '13px', color: 'rgba(245,240,234,0.7)', marginBottom: '24px' }}>
              {salon.address}
            </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '12px', marginBottom: '28px' }}>
          {[
            ...
            <div key={stat.label} style={{
              ...
              <p style={{ fontSize: '24px', fontWeight: 600, color: stat.color, marginBottom: '4px', fontFamily: 'Cormorant Garamond, serif' }}>
                {stat.value}
              </p>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: '10px',
                background: activeTab === tab.key ? '#6A5D52' : 'transparent',
                color: activeTab === tab.key ? '#F5F0EA' : '#979086',
                fontSize: '12px',
                fontWeight: 500,
        ...
        {!loading && displayBookings.length === 0 && (
          <div style={{
            ...
            {activeTab === 'upcoming' && (
              <button
                onClick={() => navigate(`/book/${SALON_ID}`)}
                style={{
                  padding: '12px 28px',
                  background: '#6A5D52',
                  color: '#F5F0EA',
